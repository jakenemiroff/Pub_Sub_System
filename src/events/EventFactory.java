...
public class EventFactory {
	...
	public static AbstractEvent createEvent(EventType eventType, int eventPublisherId, EventMessage payload) {
		...
		case TypeD:
			return new EventTypeD(EventIDMaker.getNewEventID(), eventPublisherId, payload);
		default:
			return new DefaultEventType(EventIDMaker.getNewEventID(), eventPublisherId, payload);
		}
	}
