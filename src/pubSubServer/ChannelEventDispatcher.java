...
public class ChannelEventDispatcher {
	 ...
	 */
	public void postEvent(int pubId, AbstractEvent event, List<String> listOfChannels) {
		...
		for (String channelName : listOfChannels) {
			...
			System.out.println("\n Channel " + channel.getChannelTopic() + " has event " + event.hashCode()
					+ " from publisher " + pubId);
